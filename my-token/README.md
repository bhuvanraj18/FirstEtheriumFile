...
4. Open _Solidity Compiler, choose version \*\*0.8.x_, and compile.
5. Go to _Deploy & Run Transactions_.
6. Select _JavaScript VM_.
7. Enter initial supply:

1000000000000000000000000

8. Click _Deploy_ to deploy the contract.
